          ...
          children: [
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                color: Color(0x1F098041),
                shape: BoxShape.circle
              ),
              child: Center(child: SvgPicture.asset("assets/icons/tick.svg")),
            ),
            const SizedBox(height: 26,),
            const Text("Package Delivered",style: TextStyle(
              fontSize: 24,
              fontFamily: 'Poppins',
            ...
            const Text("Your package has been delivered",style: TextStyle(
              fontSize: 16,
              fontFamily: 'Poppins',
              color: Colors.black,
              fontWeight: FontWeight.w400
            ...
            const SizedBox(height: 20),
              ...
              const Text("Thank you for choosing us!",style: TextStyle(
                fontSize: 14,
                fontFamily: 'Poppins',
                fontWeight: FontWeight.w400,
                color: Colors.black,
